function HSDemo() {
  ...
  var radiosSkin = Array.prototype.slice.call(
      document.querySelectorAll('input[type=radio][name="layoutSkinsRadio"]'),
      0
    ),
  ...
  if (skin && headerMode !== "double" && headerMode !== "double-container") {
    ...
    if (skin === "navbar-light") {
      ...
      if (sidebar) {
        for (
          var i = 0;
          i < document.querySelectorAll("aside .navbar-brand-logo").length;
          i++
        ) {
          document
        ...
        for (
          var i = 0;
          i < document.querySelectorAll("header .navbar-brand-logo").length;
          i++
        ) {
          document
            ...
            [i].setAttribute(
              "src",
              document
                .querySelectorAll("header .navbar-brand-logo")[0]
                .getAttribute("src")
                .replace("logo.svg", "logo-white.svg")
            );
        }
      ...
      for (
        var i = 0;
        i < document.getElementsByClassName("navbar-brand-logo-mini").length;
        i++
      ) {
        document
      ...
      for (
        var i = 0;
        i < document.getElementsByClassName("navbar-brand-logo-short").length;
        i++
      ) {
        document
          ...
          [i].setAttribute(
            "src",
            document
              .getElementsByClassName("navbar-brand-logo-short")[0]
              .getAttribute("src")
              .replace("logo-short.svg", "logo-short-white.svg")
          );
      }
