    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 header"><?php echo (isset($customerdetails))?'Edit Customer':'Add Customer' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="modal-footer">
                  ...
                  <button type="submit" id="btnz" class="btn"> <?php echo (isset($customerdetails))?'Update Customer':'Add Customer' ?></button>
      </div>
    </div>
    </form>
             </div>
