    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 header"><?php echo (isset($userdetails))?'Edit User':'Add User' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <form method="post" id="vehicle_add" class="card basicvalidation" action="<?php echo base_url();?>users/<?php echo (isset($userdetails))?'updateuser':'insertuser'; ?>">
                ...
                <div class="card-footer text-right">
                  <button type="submit" id="btnz" class="btn"> <?php echo (isset($userdetails))?'Update User':'Add User' ?></button>
                </div>
              </form>
             </div>
    </section>
