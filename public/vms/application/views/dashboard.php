...
<section class="content">
   <div class="container-fluid">
      <!-- Info boxes -->
      <div class="row">
         <div class="col-12 col-sm-6 col-md-3 animated animatedFadeInUp fadeInUp" >
            <div class="info-box" data-tilt data-tilt-glare data-tilt-max-glare="0.8">
               <!-- <span class="info-box-icon "><img id="iconz2" src="<?=base_url().'assets/icons/delivery-truck.png'?>"></span> -->
               <span class="info-box-icon theme-bg-default elevation-1"><i class="fas fa-truck text-white"></i></span>
               <div class="info-box-content">
                  <span class="info-box-text" id="textz">Total Vehicle's</span>
                  <span class="info-box-number" id="numb"><?= ($dashboard['tot_vehicles']!='') ? $dashboard['tot_vehicles']:'0' ?>  </span>
               </div>
               <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
         ...
         <!-- /.col -->
         <div class="col-12 col-sm-6 col-md-3 animated animatedFadeInUp fadeInUp">
            <div class="info-box mb-3" data-tilt data-tilt-glare data-tilt-max-glare="0.8">
               <!-- <span class="info-box-icon "><img id="iconz2" src="<?=base_url().'assets/icons/driver.png'?>"></span> -->
               <span class="info-box-icon bg-success elevation-1"><i class="fa fa-user-secret"></i></span>
               <div class="info-box-content">
                  <span class="info-box-text" id="textz">Total Drivers</span>
                  <span class="info-box-number" id="numb"><?= ($dashboard['tot_drivers']!='') ? $dashboard['tot_drivers']:'0' ?> </span>
               </div>
               <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
         ...
         <div class="col-12 col-sm-6 col-md-3 animated animatedFadeInUp fadeInUp">
            <div class="info-box mb-3" data-tilt data-tilt-glare data-tilt-max-glare="0.8">
               <!-- <span class="info-box-icon "><img id="iconz2" src="<?=base_url().'assets/icons/customer.png'?>"></span> -->
               <span class="info-box-icon bg-warning elevation-1"><i class="fa fa-user text-white"></i></span>
               <div class="info-box-content">
                  <span class="info-box-text" id="textz">Total Customer</span>
                  <span class="info-box-number" id="numb"><?= ($dashboard['tot_customers']!='') ? $dashboard['tot_customers']:'0' ?> </span>
               </div>
               <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
         ...
         <div class="col-12 col-sm-6 col-md-3 animated animatedFadeInUp fadeInUp">
            <div class="info-box mb-3" data-tilt data-tilt-glare data-tilt-max-glare="0.8">
               <!-- <span class="info-box-icon"><img id="iconz2" src="<?=base_url().'assets/icons/tracking.png'?>"></span> -->
               <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-id-card"></i></span>
               <div class="info-box-content">
                  <span class="info-box-text" id="textz">Today Trips</span>
                  <span class="info-box-number" id="numb"><?= ($dashboard['tot_today_trips']!='') ? $dashboard['tot_today_trips']:'0' ?></span>
               </div>
               <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
            ...
            <div class="col-md-6 animated animatedFadeInUp fadeInUp">
               <div class="card">
                  ...
                  <div class="card-footer clearfix">
                     <a href="<?= base_url() ?>reminder/addreminder"><button type="button" id="btnz" class="btn float-right"><i class="fas fa-plus"></i> Add Reminder</button></a>
                  </div>
               </div>
            </div>
         </div>
         <?php } if(userpermission('lr_liveloc')) { ?>
         <div class="col-sm-6 col-lg-6 animated animatedFadeInUp fadeInUp">
            <div class="card ">
               <div class="card-header">
