    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 header"><?php echo (isset($reminderdetails))?'Edit Reminder':'Add Reminder' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 <div class="col-sm-6 col-md-offset-2 ">
    ...
    <div class="card-body">
                  ...
                  <button type="submit" id="btnz" class="btn"> <?php echo (isset($reminderdetails))?'Update reminder':'Add reminder' ?></button>
                 </div>
