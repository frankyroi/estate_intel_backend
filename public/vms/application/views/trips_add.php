    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 header"><?php echo (isset($tripdetails))?'Edit Booking':'Add Booking' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
         ...
         <div class="card-body">
           ...
           <?php } ?>
            ...
            <div class="card-footer text-right">
               <button type="submit" id="btnz" class="btn"> <?php echo (isset($tripdetails))?'Update Trip':'Add Trip' ?></button>
            </div>
      </form>
             </div>
    </section>
