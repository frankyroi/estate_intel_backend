  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 header">SMTP Configuration
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <form id="addnewcategory" class="basicvalidation" role="form" action="<?php echo base_url(); ?>settings/smtpconfigsave" method="post"  enctype='multipart/form-data'>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <button type="button" data-toggle="modal" data-target="#modal-default" id="btnz" class="btn">Test Email</button>
                    <button type="submit" id="btnz" class="btn">Save Config</button>
                  </div>
