    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 header"><?php echo (isset($incomexpensedetails))?'Edit Income/Expense':'Add Income/Expense' ?>
            </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="modal-footer">
                  ...
                  <button type="submit" id="btnz" class="btn"> <?php echo (isset($incomexpensedetails))?'Update Income/Expense':'Add Income/Expense' ?></button>
      </div>
    </form>
             </div>
    </section>
